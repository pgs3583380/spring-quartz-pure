...
<div id="wrapper">
    ...
    <div id="page-wrapper">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label for="description" class="col-xs-3 control-label">任务别名</label>
                                <div class="col-sm-6">
                                    <input class="form-control" id="description" placeholder="description">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="jobClassName" class="col-xs-3 control-label">执行类</label>
                                <div class="col-sm-8">
                                    <input class="form-control" id="jobClassName" placeholder="jobClassName">
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <input type="hidden" id="hid_job_name">
        <input type="hidden" id="hid_job_group">
        <div class="row">
            <div class="col-md-12">
...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (flag === 0) {
                        ...
                        $("#hid_job_name").val(job.jobName);
                        $("#hid_job_group").val(job.jobGroup);
    ...
    function update() {
        ...
        var jobName = $("#hid_job_name").val();
        var jobGroup = $("#hid_job_group").val();
